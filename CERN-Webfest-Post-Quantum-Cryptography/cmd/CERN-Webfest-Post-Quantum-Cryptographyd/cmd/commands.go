...
// genesisCommand builds genesis-related `CERN-Webfest-Post-Quantum-Cryptographyd genesis` command. Users may provide application specific commands as a parameter
